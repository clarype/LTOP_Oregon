...
if __name__ == "__main__":
    ...
    input_data = pd.read_csv("/vol/v1/proj/LTOP_Oregon/tables/abstract_sample_gee/LTOP_Oregon_Abstract_Sample_annualSRcollection_Tranformed_NBRTCWTCGNDVIB5_v1.csv")
    
    # Define the output directory for the abstract images and the shapefile
    output_directory_raster = "/vol/v1/proj/LTOP_Oregon/rasters/03_AbstractImage_v2/"
    output_directory_shp = "/vol/v1/proj/LTOP_Oregon/vectors/03_abstract_image_pixel_points_v2/"
